// name: common English name, iso2: ISO 3166-1 alpha-2 (lowercase, used for flagcdn.com), dial: international calling code
...
export const defaultDialCountry = countries.find((c) => c.iso2 === "us");
